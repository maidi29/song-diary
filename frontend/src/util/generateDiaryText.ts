...
export const generateDiaryText = (mean: TrackFeatures, standardDeviation: TrackFeatures) =>
    ...
    ${
        mean.energy > 0.7 ? 
            'Additionally, I had a lot of energy and was very active' + (standardDeviation.energy > 0.3 ? ' but also tired sometimes.' : '.') : 
        mean.energy < 0.3 ? 
            'Additionally, I did not have much energy, I was limp and unmotivated' + (standardDeviation.energy > 0.3 ? ' but also energetic sometimes.' : '.') 
        : ''
    }
    ${
        mean.loudness > -5 ?
    ...
    ${
        mean.danceability > 0.7 ?
            'Also, I longed to dance and party' + (standardDeviation.danceability > 0.3 ? ' from time to time.' : ' all day long.') : 
    ...
    ${mean.acousticness > 0.5 ? 'Moreover, I was in the here and now with a clear mind.' : 'Moreover, everything felt unreal like a dream.'}
    ${mean.instrumentalness > 0.5 ? 'I worried a lot about things I can\'t change.' : 'I had few thoughts or worries.'}
    ${mean.duration_ms > 210000 ? 'Furthermore, I had a lot of stamina and got things done.' : 'Furthermore, my attention span was rather limited and I was easily distracted.'}`;