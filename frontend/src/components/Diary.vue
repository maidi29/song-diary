...
export default defineComponent({
  ...
  mounted() {
    (async () => {
      const response = await (await fetch(`https://api.unsplash.com/photos/random?query=${this.data.randomSongName}&client_id=${import.meta.env.VITE_UNSPLASH_ACCESS_KEY}`)).json();
